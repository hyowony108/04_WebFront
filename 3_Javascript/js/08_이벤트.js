...
const test1a = document.querySelector("#test-1");
...
// #test1-2 버튼 클릭시
// #test1-1 onclick 이벤트 리스너의 이벤트핸들러 제거하기
document.querySelector("#test1-2").onclick = function() {

  // 기존 oneclick 의 이벤트 핸들러(함수)를 
  // null 로 덮어씌움 (이벤트 제거)
  test1a.onclick = null;
  alert("이벤트 제거됨");
}
...
// #test1-2 요소가 클릭되었을 때 배경색 빨간색으로 변경
...
test2.addEventListener("click", function() {
  ...
  if(test2.style.opacity == 0) { // 완전히 추명해졌다면
