...
function check1(){
  ...
  // 배열명.length : 배열의 길이 (배열에 있는 칸 수 또는 저장된 데이터의 수)
  ...
  // JS배열의 특징 : 인덱스별로 자료형을 다르게 지정할 수 있다!
  
  // 길이 제한이 없다 -> 값을 배열해 원하는 만큼 추가 가능
  arr1[0] = "가";
  arr1[1] = "나";
  arr1[2] = "다";
